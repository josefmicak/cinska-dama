    ...
    class VypocetMoznychTahu
    {
        ...
        public (List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace) PridaniMoznychTahu(int poz_X_KHr, int poz_Y_KHr, int idHrace, int pocetHracu, bool hracSePohlSkokem, int delkaSkokuX, int delkaSkokuY, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace)
        {
            ...
            for (int i = 0; i < herniPole.Count; i++)
            {
                ...
                if(JeTahNevalidni(idHrace, pocetHracu, poz_X_He, poz_Y_He))
                {
                    continue;
                }

                //řeší přidání možných tahů polí přímo sousedících s vybraným polem 
                if (SplneniPodminekSousedniPole(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem)) 
                {
                    if (idHrace == 1)
                    {
                ...
                for (int j = 0; j < poleLidskehoHrace.Count; j++)
                {
                    ...
                    if (SplneniPodminekSkokyNaVodorovneOse(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem))
                    {
                        if (idHrace == 1)
                        {
                            MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                ...
                //řeší možné tahy dosažitelné pomocí skoků na vodorovné ose - počítačový hráč
                for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                {
                    ...
                    if (SplneniPodminekSkokyNaVodorovneOse(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem))
                    {
                        if (idHrace == 1)
                        {
                            MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                ...
                for (int j = 0; j < poleLidskehoHrace.Count; j++)
                {
                    ...
                    poz_X_Hr = lidskyHrac.Get_poz_X_LHr();
                    poz_Y_Hr = lidskyHrac.Get_poz_Y_LHr();
                    if (SplneniPodminekOstatniPrvotniSkoky(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem))
                    {
                        if (idHrace == 1)
                        {
                            MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                ...
                //řeši ostatní skoky (tzn. ve zbývajících 4 směrech) - počítačový hráč
                for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                {
                    PocitacovyHrac pocitacovyHrac = polePocitacovehoHrace[j];
                    poz_X_PHr = pocitacovyHrac.Get_poz_X_PHr();
                    poz_Y_PHr = pocitacovyHrac.Get_poz_Y_PHr();
                    if (SplneniPodminekOstatniPrvotniSkoky(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem))
                    {
                        if (idHrace == 1)
                        {
                            MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                ...
                //hráč provedl skok směrem dopředu nebo dozadu na y-ové ose
                if (hracSePohlSkokem && delkaSkokuY != 0)
                {
                    if (poz_Y_He == poz_Y_KHr)//právě ověřované herní kole a kliknuté hráčovo pole jsou na y-ové ose na stejné výši
                    {
                        for (int j = 0; j < poleLidskehoHrace.Count; j++)
                        {
                            ...
                            poz_X_Hr = lidskyHrac.Get_poz_X_LHr();
                            poz_Y_Hr = lidskyHrac.Get_poz_Y_LHr();
                            if (SplneniPodminekSkokNaObouOsachPoleNaStejneVysi(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX, delkaSkokuY))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                        ...
                        for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                        {
                            ...
                            poz_X_PHr = pocitacovyHrac.Get_poz_X_PHr();
                            poz_Y_PHr = pocitacovyHrac.Get_poz_Y_PHr();
                            if (SplneniPodminekSkokNaObouOsachPoleNaStejneVysi(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX, delkaSkokuY))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                    ...
                    else//právě ověřované herní kole a kliknuté hráčovo pole nejsou na y-ové ose na stejné výši
                    {
                        for (int j = 0; j < poleLidskehoHrace.Count; j++)
                        {
                            ...
                            poz_X_Hr = lidskyHrac.Get_poz_X_LHr();
                            poz_Y_Hr = lidskyHrac.Get_poz_Y_LHr();
                            if (SplneniPodminekSkokNaObouOsachPoleNaJineVysi(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX, delkaSkokuY))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                        ...
                        for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                        {
                            ...
                            poz_X_PHr = pocitacovyHrac.Get_poz_X_PHr();
                            poz_Y_PHr = pocitacovyHrac.Get_poz_Y_PHr();
                            if (SplneniPodminekSkokNaObouOsachPoleNaJineVysi(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX, delkaSkokuY))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                ...
                if (hracSePohlSkokem && delkaSkokuY == 0)
                {
                    if (poz_Y_He == poz_Y_KHr)//právě procházené herní pole je na y-ové ose na stejné výši jako pole, na které hráč skočil
                    {
                        for (int j = 0; j < poleLidskehoHrace.Count; j++)
                        {
                            ...
                            poz_X_Hr = lidskyHrac.Get_poz_X_LHr();
                            poz_Y_Hr = lidskyHrac.Get_poz_Y_LHr();
                            if (SplneniPodminekSkokNaJedneOsePoleNaStejneVysi(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                        ...
                        for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                        {
                            ...
                            poz_X_PHr = pocitacovyHrac.Get_poz_X_PHr();
                            poz_Y_PHr = pocitacovyHrac.Get_poz_Y_PHr();
                            if (SplneniPodminekSkokNaJedneOsePoleNaStejneVysi(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                    ...
                    else//právě procházené herní pole není na y-ové ose na stejné výši jako pole, na které hráč skočil
                    {
                        for (int j = 0; j < poleLidskehoHrace.Count; j++)
                        {
                            ...
                            poz_X_Hr = lidskyHrac.Get_poz_X_LHr();
                            poz_Y_Hr = lidskyHrac.Get_poz_Y_LHr();
                            if (SplneniPodminekSkokNaJedneOsePoleNaJineVysi(poz_X_Hr, poz_Y_Hr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
                        ...
                        for (int j = 0; j < polePocitacovehoHrace.Count; j++)
                        {
                            ...
                            poz_X_PHr = pocitacovyHrac.Get_poz_X_PHr();
                            poz_Y_PHr = pocitacovyHrac.Get_poz_Y_PHr();
                            if (SplneniPodminekSkokNaJedneOsePoleNaJineVysi(poz_X_PHr, poz_Y_PHr, poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, idHrace, poleLidskehoHrace, polePocitacovehoHrace, mozneTahyLidskehoHrace, mozneTahyPocitacovehoHrace, hracSePohlSkokem, delkaSkokuX))
                            {
                                if (idHrace == 1)
                                {
                                    MoznyTahLidskehoHrace tah = new MoznyTahLidskehoHrace(poz_X_He, poz_Y_He, poz_X_KHr, poz_Y_KHr, sirkaPole, vyskaPole);
        ...
        private bool JeTahNevalidni(int idHrace, int pocetHracu, int poz_X_He, int poz_Y_He)
        {
            if (((idHrace == 0 || idHrace == 2 || (idHrace == 1 && pocetHracu != 4)) && (TahDoObouHornichRohu(poz_X_He, poz_Y_He) || TahDoObouSpodnichRohu(poz_X_He, poz_Y_He))) ||
                (idHrace == 3 && (TahDoNejnizsihoANejvyssihoRohu(poz_Y_He) || TahDoHornihoPravehoRohu(poz_X_He, poz_Y_He) || TahDoSpodnihoLevehoRohu(poz_X_He, poz_Y_He))) ||
                (idHrace == 4 && (TahDoNejnizsihoANejvyssihoRohu(poz_Y_He) || TahDoHornihoLevehoRohu(poz_X_He, poz_Y_He) || TahDoSpodnihoPravehoRohu(poz_X_He, poz_Y_He))) ||
                ((idHrace == 5 || (idHrace == 1 && pocetHracu == 4)) && (TahDoNejnizsihoANejvyssihoRohu(poz_Y_He) || TahDoHornihoLevehoRohu(poz_X_He, poz_Y_He) || TahDoSpodnihoPravehoRohu(poz_X_He, poz_Y_He))) ||
                ((idHrace == 6) && (TahDoNejnizsihoANejvyssihoRohu(poz_Y_He) || TahDoHornihoPravehoRohu(poz_X_He, poz_Y_He) || TahDoSpodnihoLevehoRohu(poz_X_He, poz_Y_He))))
            {
                return true; 
            }
            return false;
        ...
        private bool SplneniPodminekSousedniPole(int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem)
        {
        ...
        private bool SplneniPodminekSkokyNaVodorovneOse(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem)
        {
        ...
        private bool SplneniPodminekOstatniPrvotniSkoky(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem)
        {
        ...
        private bool SplneniPodminekSkokNaObouOsachPoleNaStejneVysi(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem, int delkaSkokuX, int delkaSkokuY)
        {
        ...
        private bool SplneniPodminekSkokNaObouOsachPoleNaJineVysi(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem, int delkaSkokuX, int delkaSkokuY)
        {
        ...
        private bool SplneniPodminekSkokNaJedneOsePoleNaStejneVysi(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem, int delkaSkokuX)
        {
        ...
        private bool SplneniPodminekSkokNaJedneOsePoleNaJineVysi(int poz_X_Hr, int poz_Y_Hr, int poz_X_He, int poz_Y_He, int poz_X_KHr, int poz_Y_KHr, int idHrace, List<LidskyHrac> poleLidskehoHrace, List<PocitacovyHrac> polePocitacovehoHrace, List<MoznyTahLidskehoHrace> mozneTahyLidskehoHrace, List<MoznyTahPocitacovehoHrace> mozneTahyPocitacovehoHrace, bool hracSePohlSkokem, int delkaSkokuX)
        {
